...
const Chatbot = () => {
    ...
    if (input.trim()) {
      ...
      try {
        ...
        const response = await axios.post("http://127.0.0.1:11434/api/generate", {
          ...
          system: "คุณคือ AI Chatbot ที่จะตอบกลับเป็นภาษาไทยเท่านั้น", // กำหนดให้ตอบเป็นไทย
  ...
  return (
    <div className="flex flex-col h-96 w-full bg-white border border-gray-300 rounded-lg shadow-lg">
      {/* Header */}
      <div className="bg-black text-white py-2 px-4 font-bold rounded-t-lg">AI Chatbot</div>
